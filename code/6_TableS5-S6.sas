...
Table S5: Top 50 Individual Drug Combinations Under “Concomitant Use of >=3 CNS-Active Drugs” (Anrys et al.).			
Table S6: Top 50 Individual Drug Combinations Under “Any Combination of >=3 CNS-Active Drugs” (2023 AGS Beers Criteria(R)).			
...
the start date of overlapping use, end date of overlapping use, and duration of overlapping use)
     - Generated in 2a_Create_Concurrent_Med_Eps.sas
*********************************************************************/
...
- smcncr.ddi36_drugcomb_50: Output for Table S5
- smcncr.ddi91_drugcomb_50: Output for Table S6
*********************************************************************/
...
%macro calc_group_drugs(ddi);
	...
	/*** Save the 50 most prevalent drug combinations to a new dataset ***/
	...
	title1 "Sup Table: Top 50 unique drug combinations from &ddi.";
