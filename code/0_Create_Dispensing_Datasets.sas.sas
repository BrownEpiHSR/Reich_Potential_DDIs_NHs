...
libname limited 'P:\nhddi\lareich\Descriptive_DDI\Data\DerivedData\limited_partd'; 
/* limited library contains Medicare part D dispensing datasets consisting of individuals with at least one NH stay between 2018-2020 (after applying exclusion criteria) */
...
/********************************************************************************************************************************/
	...
	/* NOTE: The limited.partd_limitedexcl_2017 dataset only has dispensings from October 4, 2017 to December 31, 2017.
			 Including dispensings from October 4, 2017 onward ensures we capture prevalent medication use before 2018.  
             Any dispensings with a days supply > 90 will later be trimmed to 90 in 1_Create_Med_Eps.sas, making this start date sufficient. */
